...
def toss_coin(n):
	...
	mean = None
	outcome_no = 0
	outcome_1_count = 0 # number of sucesses
...
number_of_trials = st.slider('Number of trials?', 1, 1000, 100)
...
#st.write('It is not a funcitonal application yet. Under construction.')
